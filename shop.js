...
async function getResponce() {
  ...
  for (key in content_price) {
              ...
              <li style="width: 310px" class="d-flex flex-column m-1 p-1 border bg-info">
              ...
              <p class="card-text" >Заказать <input class="w-25" type="number" value="0" name="check" min="0" max="100" step="1"></p>
              </li>
                      `
          }
...
async function getResponce1() {
  ...
  for (key in content_title) {
              ...
              <p class="card-text" style="color: black;">${content[key].description}. Цена ${content[key].price} р.</p>
              <input type="hidden" name= "vendor_code" value=${content[key].vendor_code}>
              <p class="card-text" >Заказать <input class="w-25" type="checkbox" name="check" value="0" min="0" max="100" step="1" onClick='this.value = this.checked ? 1 : 0'></p>
              </li>
                      `
          }
